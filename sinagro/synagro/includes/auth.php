...
const MODULOS_PERFIL = [
    'admin' => [
        'dashboard', 'propriedades', 'culturas', 'ciclos',
        'animais', 'estoque', 'equipamentos', 'manutencoes',
        'financeiro', 'relatorios', 'usuarios', 'logs'
    ],
    'proprietario' => [
        'dashboard', 'propriedades', 'culturas', 'ciclos',
        'animais', 'estoque', 'equipamentos', 'manutencoes',
    ...
    'gerente' => [
        'dashboard', 'culturas', 'ciclos',
        'animais', 'estoque', 'equipamentos', 'manutencoes',
        'financeiro'
    ],
    'operador' => [
        'dashboard', 'culturas', 'ciclos',
        'estoque', 'equipamentos', 'manutencoes'
    ],
    'visualizador' => [
