...
-- -----------------------------------------------------------------------------
-- USUÁRIOS DE TESTE
-- Senha de todos: SynAgro@2025
-- Hash gerado com bcrypt (cost 12) — compatível com password_verify() do PHP
-- Para gerar novo hash: password_hash('SynAgro@2025', PASSWORD_BCRYPT)
-- -----------------------------------------------------------------------------
...
(
    'Admin SynAgro',
    'admin@synagro.com',
    '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', -- SynAgro@2025
    'admin',
    '(19) 98939-9593',
    1, 1
),
...
(1, 'Ureia',             'fertilizante', 'sc',  12,  15,  98.00, 'Depósito'), -- CRÍTICO
...
-- Usuários criados com senha: SynAgro@2025
-- =============================================================================
