...
<div class="page-body">
  ...
  <div class="section-header fade-up" style="margin-bottom:24px">
    ...
    <div style="display:flex;gap:8px;align-items:center">
      ...
      <a href="../register.php" class="btn btn-primary" style="font-size:12px;padding:8px 14px">
        + Novo Usuário
      </a>
    </div>
  </div>
  ...
  <div class="card fade-up">
    ...
    <?php if(empty($rows)): ?>
      <div class="empty-state">
        ...
        <div class="es-title">Nenhum usuário encontrado</div>
        <div class="es-sub">Clique em "+ Novo Usuário" para cadastrar.</div>
      </div>
    <?php else: ?>
